...
def main():
  ...
  with open('data.json', 'r', encoding='utf8') as datas:
    ...
    for videoId in jsonDatas:
      ...
      url = check_output(command.split()).decode('utf-8')
      ...
      thumbnail = check_output(command.split()).decode('utf-8')
  ...
  # save
  with open('datas.json', 'r', encoding='utf8') as data:
    json.dumps(modified, datas, ensure_ascii=False, indent=2)
